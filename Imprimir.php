...
Casilla, Fecha, hora, persona, Empresa, equipo,  lectura,Total,Marca,Serie, salidah FROM registros WHERE id=$id");
    ?>
        ...
        <p style="font-size: 25px">
        <div class="empresa">EMPRESA: <input type="text" name="Empresa" style="font-size: 25px" size="33" maxlength="10" value="<?= $cliente->Empresa ?>">
 ...
 <center>
 <a href="mostrar.php"><h3>Volver al inicio</h3></a>
 </center>
        <?php
        }
        ?>

...
<body>
        Buscar: <input id="searchTerm" type="text" placeholder="Buscar por cedula" onkeyup="doSearch()" size="12" maxlength="10" /> <a onClick="window.print()">🖨️Imprimir</a>   <a href="index.php"><input type="button" style="float: right;" id="Regi" value="Registrar"></a>
    <p>
<action="mostrar.php" method="post" target="_blank">
    ...
    <center>
    <h5><marquee direction="right">©BY HEALTHY AMERICA S.A.S </marquee></h5>
    </center>
</body>

...
<script type="text/javascript">
  function buscar(){
    ...
    window.location.href = 'http://192.168.2.90/Programa/index.php?opcion='+opcion;
  }
</script>
<body>
  <center>
...
<label hidden>ID:<input type="number" name="id" value="<?php echo $result1[0] ['id']?>" readonly/> </label>
      <label>Cedula:</label>
      <?php
      if (isset($result1)){?>
